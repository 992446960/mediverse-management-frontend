<template>
  ...
  >
    ...
    <div
      ...
      class="page-table__toolbar h-[52px] px-6 py-4 flex items-center justify-between border-b border-(--color-border) shrink-0"
    >
      <div class="flex items-center gap-2">
        <span v-if="(tableConf?.total ?? 0) > 0" class="text-sm text-(--color-text-secondary)">
        ...
        <span
          ...
          class="text-xs text-(--color-text-tertiary)"
    ...
    <div
      ...
      class="page-table__pagination px-6 py-4 flex justify-end border-t border-(--color-border)"
    >
      <a-pagination
