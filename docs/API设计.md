...
```json
{
"real_name": "string",非必填
"avatar_url": "string",非必填
"username": "string",非必填
"phone": "string",非必填
"email": "string",非必填
...
```http
GET /api/v1/avatars  参数新增user_id（非必填）
```
...
"scope_name": "string",
"granted_by": "3fa85f64-5717-4562-b3fc-2c963f66afa6",
"granted_by_name": "string",
"granted_at": "2026-03-16T07:24:07.905Z"
}
]
}
}
...
"dir_name": "指南",
"status": "done",
"storage_url": "https://minio.example.com/bucket/path/file?X-Amz-Signature=...",
...
| page | int | ❌ | 默认 1 |
| page_size<br>type | int<br>string | ❌<br>❌ | 默认 20<br>默认null（通过card类型查询） |
...
"created_at": "2026-05-19T06:11:13.076Z",
"updated_at": "2026-05-19T06:11:13.076Z"
}
]
}
}
...
"updated_at": "2026-05-19T06:11:51.198Z"
}
}
```
...
"from_version": 2,
"to_version": 5,
"from_md_content": "版本2的 Markdown...",
"to_md_content": "版本5的 Markdown...",
"diff": [
{
"type": "delete",
"md_content": "被删掉的段落\n",
"highlight_version": 5,
"md_content_snapshot_version": 2
},
{
"type": "insert",
"md_content": "新增的段落\n",
"highlight_version": 5,
"md_content_snapshot_version": 5
}
]
}
```
...
"message": "ok",
"data": {
"card_id": "e58fb4ff-439e-436e-8359-f2fa8cb35f05",
"action": "deleted"
}
}
```
...
"sources": [
{
"id": "745d94e7-61b5-4a33-8b68-0ace9f4bcaf4",
"file_name": "c945261422ac46ddaca0bc89644be3f8.docx",
"file_type": "docx",
"file_size": 10697,
...
{
"id": "7b6854e1-c4fc-4c5a-9452-a85850d3d64b",
"file_name": "围手术期评估手册_V2.docx",
"file_type": "docx",
"file_size": 16640,
"storage_url": "https://minio.example.com/bucket/path",
"parsed_file_url": null,
...
"message": "ok",
"data": {
"task_id": "9ae51771-49a3-48d1-b4a9-27a24fac2c40",
"file_id": "fc8a2d72-3b01-40d9-a243-0ba1bad7519e"
}
}
```
...
| owner_id | 必填 |  |  |  |
| card_type | 非必填 | 知识卡类型 |  |  |
| recall_status | 非必填 | 召回状态 |  |  |
| page | 非必填 | 页码 | 默认1 |  |
| page_size | 非必填 | 每页大小 | 默认20 |  |
...
"created_at": "2026-05-19T07:31:41.772Z",
"updated_at": "2026-05-19T07:31:41.772Z"
}
]
}
}
