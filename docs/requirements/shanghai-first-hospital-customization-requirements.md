...
| 分身配置 | 工作台分组 | 保留，如 `/my/avatar`、`/dept/avatar`、`/org/avatar` |
...
| `my-avatar` | `true` | 不展示我的工作台下的分身配置 |
| `dept` | — | 保留「科室工作台」分组及原有二级菜单 |
| `dept-avatar` | `true` | 不展示科室工作台下的分身配置 |
| `org` | — | 保留「机构工作台」分组及原有二级菜单 |
| `org-avatar` | `true` | 不展示机构工作台下的分身配置 |
| `chat` | `true` | 不展示数字医生 |
